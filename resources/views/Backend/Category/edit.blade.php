            ...
            <div class="card-body">
                    ...
                    @csrf
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name ="category_name" value="{{$category->{'category-name'} }}" >
<!-- //here i should add the validation -->
                      </div>
                      <div class="form-group">
                        <label for="exampleInputUsername1">Available Position</label>
                        <input type="text" class="form-control" name ="available_position" value="{{$category->{'available_position'} }}" >
<!-- //here i should add the validation -->
                      </div>
