...
<div class="content-wrapper">
    ...
    <tr>
       ...
       <td> {{ $row->{'available_position'} }}</td>
        <td>
            <a href="{{route('delete.category',$row->id)}}" onclick ="return confirm('are you sure you want to delte this category name')" class="btn btn-danger" style = "float:right;">Delete</a>
