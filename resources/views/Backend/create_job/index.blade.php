...
<div class="content-wrapper">
            ...
            <div class="card">
            <div class="card-body">
                    <h4 class="card-title">Job Page</h4>
    ...
    <tr>
        ...
        <td>
            <a href="{{route('delete.job',$row->id)}}" onclick ="return confirm('are you sure you want to delte this category name')" class="btn btn-danger" style = "float:right;">Delete</a>
            <a href="{{route('edit.job',$row->id)}}" class="btn btn-info" >Edit</a>
        </td>
    </tr>
@endforeach
